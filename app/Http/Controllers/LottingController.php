...
class LottingController extends Controller
{
    ...
    {   
        ...
        return view('backend.lotting.index',compact('lotting'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.lotting.create',compact('auctions','stocks','vendors_with_stocks','added_stocks'));   
    }
